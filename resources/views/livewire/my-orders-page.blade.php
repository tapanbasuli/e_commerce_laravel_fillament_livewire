            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tbody>
                ...
                if($order->status == 'cancelled') {
                  $payment_status = '<span class="bg-red-500 py-1 px-3 rounded text-white shadow">Cancelled</span>';
                }
                ...
                if($order->payment_status == 'failled') {
                  $payment_status = '<span class="bg-red-500 py-1 px-3 rounded text-white shadow">Failled</span>';
                }
                @endphp
