        ...
        <div class="flex flex-wrap mb-24 -mx-3">
          <div class="w-full pr-2 lg:w-1/4 lg:block">
              ...
              <ul>
                <li class="mb-4">
                  <label for="" class="flex items-center dark:text-gray-300">
                    <input type="checkbox" wire:model.live="featured" class="w-4 h-4 mr-2">
            ...
            <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
              ...
              <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
              <div>
                <input type="range" wire:model.live="price_range" class="w-full h-1 mb-4  bg-blue-100 rounded appearance-none cursor-pointer" max="5000000" value="1000000" step="100000">
                <div class="flex justify-between ">
                  <span class="inline-block text-sm font-bold text-blue-400 ">{{Number::currency($price_range, 'IDR')}}</span>
          ...
          <div class="w-full px-3 lg:w-3/4">
            ...
            <div class="flex flex-wrap items-center ">
              ...
              <div livewire:key="{{ $product->id }}" class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3">
